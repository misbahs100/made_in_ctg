        ...
        <div className="container mx-auto px-6 py-3 mt-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden w-full text-gray-600 md:flex md:items-center">
              ...
              <span className="mx-1 text-sm">CTG, Bangladesh</span>
            </div>
            ...
            {/* Cart, account and Mobile Menu Button */}
                ...
                <label tabIndex={0} className="btn btn-ghost btn-circle">
                  <div className="indicator">
                    <div className="flex">
                      ...
                      <sup><span className="badge badge-primary indicator-item">{totalQuantity}</span></sup>
                    </div>
                  </div>
                </label>
                <div
          ...
          {isMenuOpen && (
            <nav className="sm:hidden">
              <div className="flex flex-col">
                <Link to="/" ><p className="mt-3 text-gray-600 hover:underline">Home</p></Link>
                <Link to="/all"><p className="mt-3 text-gray-600 hover:underline">Shop</p></Link>
                <Link to="/"> <p className="mt-3 text-gray-600 hover:underline" >Categories</p></Link>
                <Link to="/contact">  <p className="mt-3 text-gray-600 hover:underline">Contact</p></Link>
                <Link to="/about"><p className="mt-3 text-gray-600 hover:underline" >About</p></Link>
              </div>
            </nav>
          )}
          ...
          <nav className="hidden sm:flex sm:justify-center sm:items-center mt-4">
            <div className="flex flex-col sm:flex-row">
              <Link to="/"><p className="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" >Home</p></Link>
              <Link to="/all"><p className="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" >Shop</p></Link>
              <Link to="/"><p className="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" >Categories</p></Link>
              <Link to="/contact"><p className="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" >Contact</p></Link>
              <Link to="/about"><p className="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" >About</p></Link>
            </div>
          </nav>
